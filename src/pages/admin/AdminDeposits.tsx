      ...
      },
      {
        onSuccess: () => {
          toast({
            ...
            description: `Le dépôt de ${tx.amount}€ a été approuvé.`,
          });
        },
        onError: () => {
          toast({
            title: "Erreur",
            description: "Impossible d'approuver le dépôt.",
            variant: "destructive",
          });
        },
      }
    ...
    updateTransaction(
      ...
      },
      {
        onSuccess: () => {
          toast({
            title: "Dépôt rejeté",
            description: `Le dépôt de ${tx.amount}€ a été rejeté.`,
          });
        },
        onError: () => {
          toast({
            title: "Erreur",
            description: "Impossible de rejeter le dépôt.",
            variant: "destructive",
          });
        },
      }
  ...
  return (
    <AdminLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold font-display">Dépôts</h1>
          <p className="text-muted-foreground mt-1">Validation des demandes de dépôt</p>
        </div>
